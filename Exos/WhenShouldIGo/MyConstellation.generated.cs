...
namespace WhenShouldIGo
{
	...
	public static class MyConstellation
	{
		...
		{
			/// <summary>
            /// Package 'GoogleTraffic' on 'MSI-FLO'
            /// </summary>
			[RealName("MSI-FLO/GoogleTraffic")]
			MSI_FLO_GoogleTraffic,
			/// <summary>
            /// Package 'Pushbullet' on 'MSI-FLO'
            /// </summary>
			[RealName("MSI-FLO/Pushbullet")]
			MSI_FLO_Pushbullet,
		}
...
namespace WhenShouldIGo.GoogleTraffic.StateObjects
{
...
namespace WhenShouldIGo.GoogleTraffic.MessageCallbacks
{
	/// <summary>
	/// Type 'TrafficData'
	/// </summary>
	...
	public static class GoogleTrafficExtensions
	{
		...
		/// </summary>
		/// <param name="package">The package</param>
		public static GoogleTrafficScope CreateGoogleTrafficScope(this WhenShouldIGo.MyConstellation.PackageInstances package)
		{
...
namespace WhenShouldIGo.PushBullet.MessageCallbacks
{
	/// <summary>
	...
	public static class PushBulletExtensions
	{
		...
		/// </summary>
		/// <param name="package">The package</param>
		public static PushBulletScope CreatePushBulletScope(this WhenShouldIGo.MyConstellation.PackageInstances package)
		{
